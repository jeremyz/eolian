...
// Syntax states
static Stm_State syntx_entry = { _syntx_entry_cb, 0, 0};
static Stm_State syntx_end = { _syntx_end_cb, 0, 0};
static Stm_State syntx_new_object = { _syntx_new_object_cb, 0, 0};
static Stm_State syntx_value = { _syntx_value_cb, 0, 0};
static Stm_State syntx_object_name = { _syntx_object_name_cb, 0, 0};
static Stm_State syntx_object_colon = { _syntx_object_colon_cb, 0, 0};
static Stm_State syntx_next_object =  { _syntx_object_next_cb, 0, 0};
static Stm_State syntx_next_array  = { _syntx_array_next_cb, 0, 0};
static Stm_State syntx_unexpected = { _syntx_unexpected_cb, 0, 0};
...
static Stm_State lex_initial = {_lex_initial_cb, 0, 0};
static Stm_State lex_int = { _lex_int_cb, 0, 0};
static Stm_State lex_int_entry = {_lex_digit_cb, (void*)&lex_int, 0};
static Stm_State lex_fraction = {_lex_frac_cb, 0, 0};
static Stm_State lex_fraction_entry = {_lex_digit_cb, (void*)&lex_fraction, 0};
static Stm_State lex_exp_sign = { _lex_exp_sign_cb, 0, 0};
static Stm_State lex_exp = { _lex_exp_cb, 0, 0};
static Stm_State lex_exp_entry = {_lex_digit_cb, (void*)&lex_exp, 0};
static Stm_State lex_string = {_lex_string_cb, 0, 0};
static Stm_State lex_string_esc = {_lex_string_esc_cb, 0, 0};
static Stm_State lex_unexpected = { _lex_unexpected_cb, 0, 0};
static Stm_State lex_true = {_lex_keyword_cb, (void*)&lex_keyword_true, 0};
static Stm_State lex_false = {_lex_keyword_cb, (void*)&lex_keyword_false, 0};
static Stm_State lex_null = {_lex_keyword_cb, (void*)&lex_keyword_null, 0};
